...
public class CriAtomEx3dSource : CriDisposable
{
	 ...
	 * \attention
	 * 設定したパラメータを実際に適用するには、 ::CriAtomEx3dSource::Update 関数を呼び出す必要があります。
	 * \sa CriAtomEx3dSource::Update, CriAtomEx3dSource::SetMinMaxDistance
	 */
	 ...
	 * \par 説明:
	 * 距離減衰による音量の変動を有効にするか無効にするかを設定します。<br>
	 * デフォルト値は true （有効）です。<br>
	 * \attention
	 * 設定したパラメータを実際に適用するには、 ::CriAtomEx3dSource::Update 関数を呼び出す必要があります。<br>
	 * \sa CriAtomEx3dSource::Update, CriAtomEx3dSource::GetAttenuationDistanceSetting
	 */
	 ...
	 * \par 説明:
	 * 距離減衰による音量の変動が有効か無効かを取得します。<br>
	 * デフォルト値は true （有効）です。<br>
	 * \sa CriAtomEx3dSource::SetAttenuationDistanceSetting
	 */
	...
	private static void criAtomEx3dSource_SetPosition(IntPtr ex_3d_source, ref CriAtomExVector position) { }
	private static void criAtomEx3dSource_SetVelocity(IntPtr ex_3d_source, ref CriAtomExVector velocity) { }
	private static void criAtomEx3dSource_SetOrientation(IntPtr ex_3d_source, ref CriAtomExVector front, ref CriAtomExVector top) { }
	private static void criAtomEx3dSource_SetConeOrientation(IntPtr ex_3d_source, ref CriAtomExVector cone_orient) { }
